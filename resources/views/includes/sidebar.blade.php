            ...
            <ul>
                ...
                @can('view-category')
                    <li class="{{ Request::routeIs('categories') ? 'active' : '' }}">
                        <a href="{{ route('categories') }}"><i class="fa-solid fa-list"></i> <span>Categories</span></a>
                    </li>
                @endcan

                @can('view-products')
                    <li class="submenu">
                        <a href="#"><i class="fa-solid fa-file"></i> <span> Products</span> <span
                ...
                @can('view-purchase')
                    <li class="submenu">
                        <a href="#"><i class="fa-solid fa-dollar-sign"></i><span> Purchase</span> <span
                                class="menu-arrow"></span></a>
                        <ul style="display: none;">
                ...
                @can('view-sales')
                    <li><a class="{{ Request::routeIs('sales') ? 'active' : '' }}" href="{{ route('sales') }}"><i
                                class="fa-solid fa-chart-simple"></i> <span>Sales</span></a></li>
                @endcan
                @can('view-supplier')
                    <li class="submenu">
                        <a href="#"><i class="fa-solid fa-user"></i> <span> Supplier</span> <span
                                class="menu-arrow"></span></a>
                        <ul style="display: none;">
                            ...
                            @can('create-supplier')
                                <li><a class="{{ Request::routeIs('add-supplier') ? 'active' : '' }}"
                                        href="{{ route('add-supplier') }}">Add Supplier</a></li>
                            @endcan
                        </ul>
                    </li>
                @endcan
                ...
                @can('view-reports')
                    <li class="submenu">
                        <a href="#"><i class="fa-solid fa-file-excel"></i> <span> Reports</span> <span
                                class="menu-arrow"></span></a>
                        <ul style="display: none;">
                ...
                @can('view-access-control')
                    <li class="submenu">
                        <a href="#"><i class="fa-solid fa-lock"></i> <span> Access Control</span> <span
                                class="menu-arrow"></span></a>
                        <ul style="display: none;">
                            @can('view-permission')
                ...
                @can('view-users')
                    <li class="{{ Request::routeIs('users') ? 'active' : '' }}">
                        <a href="{{ route('users') }}"><i class="fa-solid fa-user-group"></i> <span>Users</span></a>
                    </li>
                @endcan

                <li class="{{ Request::routeIs('profile') ? 'active' : '' }}">
                    <a href="{{ route('profile') }}"><i class="fa-solid fa-user-plus"></i> <span>Profile</span></a>
                </li>
                @can('view-settings')
